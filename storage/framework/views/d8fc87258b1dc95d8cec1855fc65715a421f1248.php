<?php $__env->startSection('title'); ?> <?php echo app('translator')->get('translation.Alerts'); ?>  <?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('li_1'); ?> Components <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Alerts <?php $__env->endSlot(); ?>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Alert Live Examples</h4>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc">You can use flexbox utilities and Icons to create alerts with icons</p>
            </div><!-- end card header-->
...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Top Border Alerts</h4>
                <p class="card-title-desc">Top border alert example</p>
            </div><!-- end card header-->
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Label Icon Arrow Alerts</h4>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc">Success, Error and Warning Alert Examples.</p>
            </div><!-- end card header-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\endezyareli\Downloads\dason-laravel-admin-dashboard-template-2022-06-04-05-40-33-utc\Dason-Laravel_v1.0.0\Admin\resources\views/ui-alerts.blade.php ENDPATH**/ ?>